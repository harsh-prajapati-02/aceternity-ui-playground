 ...
 * - Desktop: bottom bar with expanding icons
 * - Mobile: floating button bottom-right with expandable menu
 */
"use client";
...
const FloatingDockMobile = ({
  ...
  return (
    <div className={cn("fixed bottom-4 right-4 block md:hidden z-5", className)}>
      <AnimatePresence>
        {open && (
          <motion.div
            layoutId="nav"
